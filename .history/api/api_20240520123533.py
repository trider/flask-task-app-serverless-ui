...
namespace = Namespace('flask-task-app', 'Flask Task App API Endpoints')

flask_task_app_model = namespace.model('TaskAPI', {
...
@namespace.marshal_list_with(flask_task_app_model)
